[![Build Status](https://travis-ci.org/sparwelt/minimalistic-prismic-dom-parser.svg?branch=master)](https://travis-ci.org/sparwelt/minimalistic-prismic-dom-parser)
